...
const showUI=((list)=>{
      ...
      list.forEach((obj,idx) => {
            ...
            newCard.innerHTML=`<img src="${obj.videoThumbnails[0].url}" onmouseover="handleHover(event,${idx})">
            <h6>${obj.author}</h6>
            <p>${obj.title}</p>
            `;
...
const handleHover = ((e,index)=>{
      const lastImage = dummyData[idx].videoThumbnails[0].pop();
